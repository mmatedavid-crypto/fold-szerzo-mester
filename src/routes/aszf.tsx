    ...
    <PageShell>
      <article className="container mx-auto px-4 py-12 max-w-3xl prose prose-stone dark:prose-invert">
        ...
        <p>
          ...
          <strong>szerződés-előkészítő irat</strong>; nem minősül ügyvédi képviseletnek vagy egyedi
          jogi tanácsadásnak. A sablon a 2013. évi CXXII. törvény (Földforgalmi tv.) és a Polgári
          Törvénykönyv aktuális rendelkezésein alapul.
        </p>
        ...
        <p>
          ...
          a Felhasználó egy szerződés generálására jogosult; előfizetés esetén az éves keret
          szerint. A megrendelést követően elektronikus számla kerül kiállításra.
        </p>

        <h2>5. Elállási jog</h2>
        <p>
          A 45/2014. (II. 26.) Korm. rendelet 29. § (1) bek. m) pontja alapján a digitális tartalom
          (generált PDF) szolgáltatása megkezdésével — a Felhasználó kifejezett előzetes
          hozzájárulásával — az elállási jog megszűnik. Le nem töltött kreditre az elállás 14 napon
          belül gyakorolható.
        </p>
        ...
        <p>
          A sablonok, a klauzulatár és a szolgáltatás kódbázisa a Szolgáltató szellemi tulajdona. A
          generált egyedi szerződés a Felhasználó tulajdona, szabadon felhasználható.
        </p>

        <h2>8. Adatkezelés</h2>
        <p>
          Részletek az <a href="/adatkezeles">Adatkezelési tájékoztatóban</a>. A süti használatról a{" "}
          <a href="/cookie-szabalyzat">Süti tájékoztató</a> rendelkezik.
        </p>
